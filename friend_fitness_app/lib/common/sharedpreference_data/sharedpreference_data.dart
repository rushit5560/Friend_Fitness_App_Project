...
class SharedPreferenceData{
  ...
  setUserLoginDetailsInPrefs({required int userId, required String userIdToken, required String gameId, required int roleId}) async {
    ...
    //log('UserDetails.gameId store : ${UserDetails.gameId}');
